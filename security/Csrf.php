...
class Csrf
{
    ...
    */
    ...
    public static function getToken(): string
    {
        ...
        $time = isset($_SESSION[self::TIME_KEY])
            ? (int) $_SESSION[self::TIME_KEY]
            : 0;
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | GET, HEAD and OPTIONS are normally read-only requests.
    |
    | POST, PUT, PATCH and DELETE are protected.
    |
    */
    ...
    public static function verifyRequest(): void
    {
        ...
        /*
         * No CSRF check for normally read-only requests.
         */
        if (!in_array(
            $method,
            $protectedMethods,
    ...
    |--------------------------------------------------------------------------
    |
    | Useful after login, logout or another sensitive
